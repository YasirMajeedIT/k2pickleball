...
<head>
    ...
    <title>Partner Application — K2 Platform</title>
...
<body class="bg-navy-950 text-white min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative bg-navy-900 items-center justify-center overflow-hidden">
        ...
        <div class="relative text-center px-12">
            ...
            <h2 class="font-display text-2xl font-bold text-white mb-4">Join the K2 Partnership</h2>
            <p class="text-slate-400 leading-relaxed max-w-sm mx-auto">Create your partner account to begin your journey toward launching a thriving pickleball facility.</p>
            <div class="mt-10 space-y-3 text-left max-w-xs mx-auto">
                <?php
                $benefits = ['Full K2 Platform access', 'Dedicated launch support', 'Revenue-aligned partnership', 'Continuous platform updates'];
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div class="w-full max-w-md" x-data="{ showPassword: false, loading: false }">
            ...
            <h1 class="font-display text-3xl font-extrabold text-white">Create Account</h1>
            <p class="mt-2 text-sm text-slate-400">Start your partner application.</p>
            ...
            <form class="mt-8 space-y-5" @submit.prevent="loading = true">
                ...
                <div class="flex items-start gap-2">
                    <input type="checkbox" required id="terms" class="w-4 h-4 mt-0.5 rounded border-navy-700 bg-navy-900/60 text-gold-500 focus:ring-gold-500/20">
