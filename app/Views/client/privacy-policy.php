...
<section class="py-16 lg:py-24 relative">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose-custom">
        ...
        $sections = [
            ...
            ['Contact Us', 'If you have questions about this Privacy Policy or our data practices, please contact us at:<br><br>K2 Pickleball Platform<br>Tampa Bay, Florida<br>Email: privacy@k2pickleball.com'],
        ];
