...
<style>
  ...
  .btn { display: inline-block; padding: 14px 32px; background: #059669; color: #ffffff !important; text-decoration: none; border-radius: 10px; font-size: 15px; font-weight: 600; margin: 8px 0 24px; }
...
<div class="wrapper">
  <div class="header">
    <div class="header-logo">
      ...
      <span class="header-name">K2 Pickleball</span>
    </div>
  </div>
