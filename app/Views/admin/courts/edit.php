<?php
$title = 'Edit Court';
$breadcrumbs = [['label' => 'Courts', 'url' => ($baseUrl ?? '') . '/admin/courts'], ['label' => 'Edit']];

$formId = 'courtEditForm';
    ...
    return {
        ...
        async submitForm() {
            ...
            try {
                ...
                const json = await res.json();
                if (res.ok) {
                    window.dispatchEvent(new CustomEvent('toast', { detail: { message: 'Court updated', type: 'success' } }));
